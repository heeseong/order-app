...
('아메리카노(ICE)', '에스프레소에 물을 넣어 만든 시원한 아이스 커피', 4000, 'https://images.unsplash.com/photo-1509042239860-f550ce710b93?w=400&h=300&fit=crop', 10),
...
('카라멜 마키아토', '카라멜 시럽이 들어간 달콤한 마키아토', 6000, 'https://images.unsplash.com/photo-1517487881594-2787fef5ebf7?w=400&h=300&fit=crop', 10),
